...
// Load the image collection.   
var dataset_3 = ee.ImageCollection('LANDSAT/LE07/C02/T1_L2').filterDate('2001-02-01', '2001-05-31').filterBounds(region);
// Compute the median.
...
// Load the image collection.
var dataset_4 = ee.ImageCollection('LANDSAT/LE07/C02/T1_L2').filterDate('2001-10-01', '2002-1-31').filterBounds(region);
// Compute the median.
...
// Load the image collection.
var dataset_5 = ee.ImageCollection('LANDSAT/LE07/C02/T1_L2').filterDate('2002-02-01', '2002-05-31').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_5,
    description: 'landsat7_premonsoon_2002',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
// Load the image collection.
var dataset_6 = ee.ImageCollection('LANDSAT/LE07/C02/T1_L2').filterDate('2002-10-01', '2003-1-31').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_6,
    description: 'landsat7_postmonsoon_2002',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
// Load the image collection.
var dataset_7 = ee.ImageCollection('LANDSAT/LE07/C02/T1_L2').filterDate('2003-02-01', '2003-05-31').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_7,
    description: 'landsat7_premonsoon_2003',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
// Load the image collection.
var dataset_8 = ee.ImageCollection('LANDSAT/LE07/C02/T1_L2').filterDate('2003-10-01', '2004-1-31').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_8,
    description: 'landsat7_postmonsoon_2003',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
// Load the image collection.
var dataset_9 = ee.ImageCollection('LANDSAT/LE07/C02/T1_L2').filterDate('2004-02-01', '2004-05-31').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_9,
    description: 'landsat7_premonsoon_2004',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
// Load the image collection.
var dataset_10 = ee.ImageCollection('LANDSAT/LE07/C02/T1_L2').filterDate('2004-10-01', '2005-1-31').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_10,
    description: 'landsat7_postmonsoon_2004',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
