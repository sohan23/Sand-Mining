...
var dataset_17 = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterDate('2016-06-01', '2016-09-30').filterBounds(region);
// Compute the median.
...
//for the year 2017
// Load the image collection.
var dataset_18 = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterDate('2017-06-01', '2017-09-30').filterBounds(region);
// Compute the median.
...
//for the year 2018
// Load the image collection.
var dataset_19 = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterDate('2018-06-01', '2018-09-30').filterBounds(region);
// Compute the median.
...
//for the year 2019
// Load the image collection.
var dataset_20 = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterDate('2019-06-01', '2019-09-30').filterBounds(region);
// Compute the median.
...
//for the year 2020
// Load the image collection.
var dataset_21 = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterDate('2020-06-01', '2020-09-30').filterBounds(region);
// Compute the median.
...
//for the year 2021
// Load the image collection.
var dataset_22 = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterDate('2021-06-01', '2021-09-30').filterBounds(region);
// Compute the median.
...
//for the year 2022
// Load the image collection.
var dataset_23 = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterDate('2022-06-01', '2022-09-30').filterBounds(region);
// Compute the median.
