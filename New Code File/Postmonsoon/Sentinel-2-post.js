...
var dataset_17 = ee.ImageCollection('COPERNICUS/S2').filterDate('2016-10-01', '2016-12-31').filterBounds(region);
// Compute the median.
...
//for the year 2017
// Load the image collection.
var dataset_18 = ee.ImageCollection('COPERNICUS/S2').filterDate('2017-10-01', '2017-12-31').filterBounds(region);
// Compute the median.
...
//for the year 2018
// Load the image collection.
var dataset_19 = ee.ImageCollection('COPERNICUS/S2').filterDate('2018-10-01', '2018-12-31').filterBounds(region);
// Compute the median.
...
//for the year 2019
// Load the image collection.
var dataset_20 = ee.ImageCollection('COPERNICUS/S2').filterDate('2019-10-01', '2019-12-31').filterBounds(region);
// Compute the median.
...
//for the year 2020
// Load the image collection.
var dataset_21 = ee.ImageCollection('COPERNICUS/S2').filterDate('2020-10-01', '2020-12-31').filterBounds(region);
// Compute the median.
...
//for the year 2021
// Load the image collection.
var dataset_22 = ee.ImageCollection('COPERNICUS/S2').filterDate('2021-10-01', '2021-12-31').filterBounds(region);
// Compute the median.
...
//for the year 2022
// Load the image collection.
var dataset_23 = ee.ImageCollection('COPERNICUS/S2').filterDate('2022-10-01', '2022-12-31').filterBounds(region);
// Compute the median.
