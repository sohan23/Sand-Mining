...
var dataset_17 = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterDate('2016-02-01', '2016-05-31').filterBounds(region);
// Compute the median.
...
//for the year 2017
// Load the image collection.
var dataset_18 = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterDate('2017-02-01', '2017-05-31').filterBounds(region);
// Compute the median.
...
//for the year 2018
// Load the image collection.
var dataset_19 = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterDate('2018-02-01', '2018-05-31').filterBounds(region);
// Compute the median.
...
//for the year 2019
// Load the image collection.
var dataset_20 = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterDate('2019-02-01', '2019-05-31').filterBounds(region);
// Compute the median.
...
//for the year 2020
// Load the image collection.
var dataset_21 = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterDate('2020-02-01', '2020-05-31').filterBounds(region);
// Compute the median.
...
//for the year 2021
// Load the image collection.
var dataset_22 = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterDate('2021-02-01', '2021-05-31').filterBounds(region);
// Compute the median.
...
//for the year 2022
// Load the image collection.
var dataset_23 = ee.ImageCollection('COPERNICUS/S2_SR_HARMONIZED').filterDate('2022-02-01', '2022-05-31').filterBounds(region);
// Compute the median.
