...
// Load the image collection.
var dataset_5 = ee.ImageCollection('LANDSAT/LE07/C02/T1_L2').filterDate('2010-02-01', '2010-05-31').filterBounds(region);
print(dataset_5);
// Compute the median.
...
Export.image.toDrive({
    image: bands_5,
    description: 'landsat8_premonsoon_2010',
    folder: 'GEE_Image_Composite',
    scale: 30,
    region: region
});
...
// Load the image collection.
var dataset_6 = ee.ImageCollection('LANDSAT/LE07/C02/T1_L2').filterDate('2010-10-01', '2011-1-31').filterBounds(region);
print(dataset_6);
// Compute the median.
...
Export.image.toDrive({
    image: bands_6,
    description: 'landsat8_postmonsoon_2010',
    folder: 'GEE_Image_Composite',
    scale: 30,
    region: region
});
